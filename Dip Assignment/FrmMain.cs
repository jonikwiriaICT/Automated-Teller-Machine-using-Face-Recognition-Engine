            ...
            try
            {
                ...
                else
                {
                    ...
                    if (username != String.Empty)
                    {
                        ...
                        if(count >= 1)
                        {
                            DialogResult result = MessageBox.Show("Customer recognized as " + username + ". Is your Username " + username + "?", "Confirm your identity", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                            if (result == DialogResult.Yes)
                            {
                                Hide();
                                var ATMMain = new UserATMTransaction();
                                if (ATMMain.ShowDialog() == DialogResult.Cancel)
                                {
                                    Application.Exit();
                                }
                            }
                        ...
                        {
                            MessageBox.Show("Customer Recognized as " + username + " but this student is not reg in this course");
                        }
                    }
                    else
                    {
